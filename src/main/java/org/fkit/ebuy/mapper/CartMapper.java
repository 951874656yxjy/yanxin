...
public interface CartMapper {
	...
	Cart newcart(@Param("id")int id,@Param("name")String name,@Param("price")String price,@Param("image")String image,@Param("number")String number,
...
//	测试
	@Delete("delete from tb_cart where id=#{id} and username=#{username}")
	...
	@Select(" select * from tb_cart where id=#{id} and username=#{username} ")
